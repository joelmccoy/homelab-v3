...
| ![Loki](https://img.shields.io/badge/Loki-F46800?style=flat-square&logo=grafana&logoColor=white) | Loki | Log aggregation in Monolithic mode, chunks on RustFS via an Argo-managed bucket bootstrap Job. | [`k8s/apps/loki/`](k8s/apps/loki/) | [Docs](https://grafana.com/docs/loki/latest/) |
